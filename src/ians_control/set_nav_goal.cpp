...
int main(int argc, char** argv){
    ...
    int x_dest, y_dest, x_start, y_start;
    sprintf(argv[3], "%d", x_dest);
    sprintf(argv[4], "%d", y_dest);
    sprintf(argv[5], "%d", x_start);
    sprintf(argv[6], "%d", x_start);
    ...
    goal.base_position.pose.position.x = x_start;
    goal.base_position.pose.position.y = y_start;
    goal.base_position.pose.orientation.w = 1.0;
